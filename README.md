...
React Native application that utilises the openweathermap.org free 5 day API to fetch weather data and display it to the user, and it is built using expo.
